        ...
        <div className={
            ...
            {/* <nav className="flex flex-col py-4">
                ...
                {/* <nav className="flex flex-col py-4 items-center text-base lg:text-lg justify-center uppercase text-white leading-[24px]">
                    ...
                    <Link href={'/news'}onClick={() => setMenuOpen(!menuOpen)} className='py-4 pl-2 w-full rounded uppercase hover:border-b-2 hover:bg-white hover:border-red-900 hover:text-red-900 font-600'>
                        News
                    </Link>
